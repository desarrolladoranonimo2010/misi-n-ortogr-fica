...
const MEANING_CHALLENGES = [
  { id: "mng1", sentence: "Cada verano hacemos una ___ campestre junto al río.", options: [{ text: "gira", correct: false }, { text: "jira", correct: true }], explanation: "'Jira' significa merienda o banquete campestre. 'Gira' es una excursión o el verbo girar." },
  { id: "mng2", sentence: "La banda anunció su próxima ___ por varias ciudades.", options: [{ text: "gira", correct: true }, { text: "jira", correct: false }], explanation: "'Gira' (excursión, recorrido) es lo correcto aquí; 'jira' es un pedazo de tela o una merienda campestre." },
  { id: "mng3", sentence: "Es importante ___ suficiente agua durante el día.", options: [{ text: "ingerir", correct: true }, { text: "injerir", correct: false }], explanation: "'Ingerir' significa introducir alimentos o líquidos en el cuerpo. 'Injerir' es entrometerse." },
  { id: "mng4", sentence: "Prefiere no ___ en los asuntos ajenos.", options: [{ text: "ingerir", correct: false }, { text: "injerir", correct: true }], explanation: "'Injerir(se)' significa entrometerse. 'Ingerir' es introducir alimentos en el cuerpo." },
  { id: "mng5", sentence: "Las plantas del jardín empezaron a ___ tras la lluvia.", options: [{ text: "vegetar", correct: true }, { text: "vejetar", correct: false }], explanation: "'Vegetar' se refiere a crecer las plantas (o vivir de forma pasiva). 'Vejetar' no es la forma correcta: la palabra siempre se escribe con G." },
  { id: "mng6", sentence: "El sofrito necesita solo un ___ picado.", options: [{ text: "agito", correct: false }, { text: "ajito", correct: true }], explanation: "'Ajito' es el diminutivo de 'ajo'. 'Agito' es una forma del verbo agitar." },
  { id: "mng7", sentence: "Yo ___ la mezcla antes de servirla.", options: [{ text: "agito", correct: true }, { text: "ajito", correct: false }], explanation: "'Agito' es la forma verbal de 'agitar'. 'Ajito' es el diminutivo de 'ajo'." }
];

const FINAL_MEANING_CHALLENGES = [
  { id: "fmng1", sentence: "La auditoría detectó una ___ indebida del proveedor en las decisiones del comité.", options: [{ text: "injerencia", correct: true }, { text: "ingerencia", correct: false }], explanation: "'Injerencia' significa intromisión. La forma 'ingerencia' es incorrecta; 'ingerir' pertenece al campo de la alimentación." },
  { id: "fmng2", sentence: "El investigador presentó la hipótesis como una ___ provisional, no como una conclusión demostrada.", options: [{ text: "conjetura", correct: true }, { text: "congetura", correct: false }], explanation: "'Conjetura' se escribe con J y designa una opinión formada a partir de indicios, pero no plenamente demostrada." },
  { id: "fmng3", sentence: "La comisión reclamó mayor ___ para evitar que los criterios del informe resultaran incompatibles.", options: [{ text: "homogeneidad", correct: true }, { text: "homojeneidad", correct: false }], explanation: "'Homogeneidad' pertenece a la familia de homogéneo y conserva la G en la terminación culta." }
];
